...
!  nrstr_angl, [rstang] (allocating memory for rstang)
...
!  nrstr_pos, [rstpos] (allocating memory for rstpos)
!  nrstr_dist, [rstdis] (allocating memory for rstdis)
!  nrstr_angl, [rstang] (allocating memory for resang)
!  nrstr_wall, [rstwal] (allocating memory for rstwal)
...
!  rstdis, nrstr_angl, rstang, nrstr_wall, rstwal, xwcent
