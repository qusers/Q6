...
!locals
 ...
 do i = s%first, s%last
  if( (( (solute(i).neqv. .FALSE.) .eqv. s%solute1) .or. ( (solute(i).neqv. .FALSE.) .eqv. s%solute2)).and.&
      (( (excl(i).neqv. .FALSE.) .eqv. s%excl1) .or. ( (excl(i).neqv. .FALSE.) .eqv. s%excl2)) .and. &
      (( ((shell(i).neqv. .FALSE.) .or. (excl(i).neqv. .FALSE.)) .eqv. s%restr1) .or. (( (shell(i).neqv. .FALSE.) .or. (excl(i).neqv. .FALSE.)) .eqv. s%restr2)) .and. &
      (( (heavy(i).neqv. .FALSE.) .eqv. s%heavy1) .or. ( (heavy(i).neqv. .FALSE.) .eqv. s%heavy2)) .and. &
      (( (sybyl(i).neqv. .FALSE.) .eqv. s%sybyl1) .or. ( (sybyl(i).neqv. .FALSE.) .eqv. s%sybyl2))) then
