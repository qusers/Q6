...
!                allocate(gapmin(fileheader%arrays),gapmax(fileheader%arrays), &
!                        dgf(nfiles,fileheader%arrays),dgr(nfiles,fileheader%arrays),dgfsum(nfiles,fileheader%arrays),&
!                        dgrsum(nfiles,fileheader%arrays),dG(nfiles,fileheader%arrays),STAT=ERR)
!                if(ERR /= 0) then
!                        stop 'Qfep5 terminated abnormally: Out of memory when allocating arrays. 21 '
!                end if
