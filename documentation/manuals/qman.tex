...
Å  in non-bonded  interactions uses  about  50 to  200 Mb  of RAM  memory
...
reading routines in Q are not able to read files from other programs.
...
The newest addition to Q is performing BQCP \cite{Major2007a,Gao2008} calculations. This is
...
\subsection{Additional information for BQCP calculations}
...
in the input file for \textbf{qdyn}.\\
...
for different isotopes in the \textbf{qdyn} input file, masses will be automatically 
...
for already completed simulations. For this, the program \textbf{qpi} can be used,
...
the initial simulation in \textbf{qdyn}, with a small number of changes.
...
line \textbf{temperature} is not specified, \textbf{QPI} will require a restart
...
\hline bath\_coupling & Temperature bath relaxation time T (fs) to use with berendsen thermostat\cite{Berendsen:1984}. & Optional, default 100 fs. Must be $\geq$ stepsize. \\
...
\hline temperature & Interval for printing temperature. It will always be printed if it changed by $>$ 2\% since last printed and if verbose{\_}temp is set. & Optional, default 10.\\
...
\hline
\multicolumn{3}{p{394pt}}{}\\
\multicolumn{3}{p{394pt}}{[\textbf{qcp{\_}atoms}]: Individual definition of atoms to include for BQCP calculations. Only needed if not defined in qdyn or qpi input file.}\\
...
\bibitem{Major2007a} Major, D.T. and Gao, J., An Integrated Path Integral and Free--Energy Perturbation--Umbrella Sampling Method for Computing Kinetic Isotope Effects of Chemical Reactions in Solution and in Enzymes, J. Chem. Theo. Comp., 3, 949--960, 2007

\bibitem{Gao2008} Gao, J., Wong, K.--Y., Major, D.T., Combined QM/MM and Path Integral Simulations of Kinetic Isotope Effects in the Proton Transfer Reaction Between Nitroethane and Acetate Ion in Water, J. Comp. Chem., 4, 514--522, 2008
