...
programs. The main program is \textbf{qdyn} which carries out the actual
...
of free energies utilising energy data produced by \textbf{qdyn}. A number
...
information about the system and are used in the \textbf{qdyn} simulation.
...
The information from the \textbf{qdyn} simulation is gathered in a log
...
\begin{itemize}
\item Solvation is done in Qprep, not in \textbf{qdyn}. The topology thus contains all the atoms of the simulated system.
...
\hline
 ...
 notes:    &   Qdum is a version of \textbf{qdyn} without the dynamics loop. It reads all input, initiates the
...
(\textbf{qdyn}, Qprep5, Qfep5, Qdum5, Qcalc5).
