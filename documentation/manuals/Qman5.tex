...
\begin{figure}[h]
\begin{center}
\resizebox{8cm}{!}{\includegraphics[scale=0.7]{Pictures/Q-logo_2.pdf}}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\resizebox{15cm}{!}{\includegraphics*{Pictures/Q_overview_2.pdf}}
...
\begin{figure}[h]
\begin{center}
\resizebox{10cm}{!}{\includegraphics*{Pictures/EVB_states_2.pdf}}
...
between these pairs of atom are given by:
...
is useful do define some groups of atoms and calculate the
...
\begin{figure}[hbt]
\begin{center}
\includegraphics*[scale=0.6]{Pictures/speedup.pdf}
...
\begin{figure}[hbt]
\begin{center}
\includegraphics*[scale=0.6]{Pictures/efficiency.pdf}
...
\centering
\includegraphics*[scale=1]{Pictures/Qfep_out.pdf}
\label{fig:Qfep-out}
\end{figure}
...
\begin{figure}[h]
\centerline{\includegraphics*[width=5.92in,height=3.45in]{Pictures/tutorial_energies.pdf}}
...
\begin{figure}[h]
\centerline{\includegraphics*[scale=0.9]{Pictures/modules.pdf}}
...
\begin{figure}[h]
\begin{center}
\includegraphics*[scale=0.8]{Pictures/lib_ex.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics*[scale=0.8]{Pictures/prm_ex.pdf}
...
\hline bath\_coupling & Temperature bath relaxation time T (fs)\cite{Berendsen:1984}. & Optional, default 10 fs. Must be $\geq$ stepsize. \\
...
\hline lrf & LRF Taylor expansion of electrostatic field beyond cut-off radius (on/off). & Optional, default off.\\
\hline
