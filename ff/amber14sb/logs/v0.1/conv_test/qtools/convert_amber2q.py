...
try:
    from Qpif.qparameter import QPrm
except ImportError:
    print "QTools not installed"
    sys.exit(1)

from Qpif.qlibrary import QLib
from Qpif.qstructure import QStruct
from Qpif.qtopology import QTopology
from Qpif.common import SpecialFormatter

logger = logging.getLogger('Qpif')
...
qal2 = QLib("amber")
qap2 = QPrm("amber")
qas2 = QStruct("../all_amino_acids.pdb", "pdb")
